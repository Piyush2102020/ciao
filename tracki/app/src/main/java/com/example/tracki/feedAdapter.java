...
public class feedAdapter extends RecyclerView.Adapter<feedAdapter.ViewHolder> {
    ...
    public feedAdapter(ArrayList<msgModel> chat, Context context){
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (msgModels.get(position).gender!=null){
        ...
        holder.sender.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("receiver",msgModels.get(position).sender);
                intent.putExtra("gender",msgModels.get(position).gender);
